...
from models import ConvVAE4Fixed, AtariVAE2DLatent
...
if __name__ == '__main__':
    ...
    run_fac.run_list.append(Run(model, opt, Params(MseKldLoss), co_ord_conv_data_package, run_name='biglatent MSE with co-conv'))
